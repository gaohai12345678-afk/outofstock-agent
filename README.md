...
> 闪购场景下，商家发现商品缺货时由 Agent 主动致电用户，协商换货或退款的智能客服系统。
> 含完整评测体系：16 条测试用例 × 3 轮，意图识别通过率 100%（关键字基线 75%）。

## 为什么做这个场景

真实亲历：本人在美团闪购下单遇到商家缺货电话协商，确认"缺货协商"是一个**事件驱动、多轮交互、天然需要人工兜底**的真实业务场景——不是照抄教程的通用聊天机器人。
